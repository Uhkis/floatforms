/*! Floatforms - v0.1.0 - 2015-04-10
* http://uhkis.github.io/floatforms/
* Copyright (c) 2015 Janne Hakala; Licensed MIT */
(function ( $ ) {
$.fn.floatforms = function( options ) {
  ...
  $(this).find('input').on('blur focusout', function() {
    ...
    var id = $this.attr('id');
    var $container = $('<div>').attr('id', 'input-' + id).addClass('floatforms-moved');
